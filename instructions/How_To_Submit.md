# CS 1440 Assignment 4: Refactoring & Design Patterns - How to Submit this Assignment
...
1.  In the work force **your boss and coworkers will be just as picky as I am** about how you turn in your work.  Perhaps more so.  It is not good enough if your code "just works" on your computer.  You code needs to "just work" on their computers, too.
...
0.  Open the repo's settings in GitLab by hovering over the gear icon in the left side bar and clicking `General`
...
0.  In your shell, navigate into a different directory and `git clone` your repository.
    *   You can find the URL on to clone by running `git remote -v` in your original repository, or on the GitLab web site.
